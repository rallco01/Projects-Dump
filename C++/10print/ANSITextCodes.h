...
std::string customColor(bool highlight, int color)
{
	...
	{
		std::cerr<<"Error in using the \u001b[33mcustomColor(bool highlight, \u001b[31mint color\u001b[33m)\u001b[0m method, please make sure that the color value is between 0-255 inclusive"<<std::endl;
...
std::string customColor(bool highlight, int color, std::string text)
{
	...
	if(color < 0 || color > 255)
	{
		std::cerr<<"Error in using the \u001b[33mcustomColor(bool highlight, \u001b[31mint color\u001b[33m, std::string text)\u001b[0m method, please make sure that the color value is between 0-255 inclusive"<<std::endl;
		std::exit(EXIT_FAILURE);
	}
	std::string code = "\033[";
	if(highlight)
...
std::string customColor(bool highlight, int rValue, int gValue, int bValue)
{
	...
	if(error)
	{
		...
		std::cerr<<"Please make sure that the rValue, gValue, and bValue are all between 0-255 inclusive"<<std::endl;
		std::exit(EXIT_FAILURE);
	}
